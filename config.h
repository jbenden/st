...
static char *font2[] = { "Inconsolata for Powerline:pixelsize=10:antialias=true:autohint=true" };
...
MouseKey mkeys[] = {
	...
	{ Button4,              XK_NO_MOD,      kscrollup,      {.i =  10} },
	{ Button5,              XK_NO_MOD,      kscrolldown,    {.i =  10} },
 ...
 */
static uint forceselmod = 0; //ShiftMask;
